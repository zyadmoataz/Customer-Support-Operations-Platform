...
export function LoginPage() {
  ...
  const { register, handleSubmit, setValue, formState: { errors, isSubmitting } } = useForm<AuthFormValues>({
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button disabled={isSubmitting} type="submit" className="w-full py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-sm transition-all duration-200 shadow-lg shadow-indigo-600/20 disabled:opacity-50 hover:shadow-indigo-500/40">
