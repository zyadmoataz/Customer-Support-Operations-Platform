...
const priorityStyles: Record<TicketPriority, { text: string; bg: string }> = {
  ...
  medium: {
    text: "text-sky-300",
    bg: "bg-sky-950/60 border border-sky-500/20",
  },
  high: {
    text: "text-amber-300",
    bg: "bg-amber-950/60 border border-amber-500/20",
  },
  urgent: {
    text: "text-rose-300",
    bg: "bg-rose-950/60 border border-rose-500/20",
  },
};
        ...
        <div>
          <div className='flex flex-wrap items-center justify-between gap-2 mb-3'>
            <div className='flex flex-wrap items-center gap-1.5'>
              ...
              <span
                className={`px-2 py-0.5 rounded-md text-[10px] uppercase font-bold tracking-wider ${priority.bg} ${priority.text}`}
              >
